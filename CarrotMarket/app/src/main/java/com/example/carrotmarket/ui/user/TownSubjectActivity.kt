...
import com.example.carrotmarket.databinding.ActivityTownSubjectBinding
import com.example.carrotmarket.databinding.ActivityWatchlistBinding

class TownSubjectActivity: AppCompatActivity() {
    private lateinit var binding: ActivityTownSubjectBinding

    override fun onCreate(savedInstanceState: Bundle?){
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this, R.layout.activity_town_subject)
    }
